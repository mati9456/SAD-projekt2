...
par(las = 2)
plot(1:length(accidents_per_weekdays), fully_uniform_weekdays, type='l', col='#F6C85F', xlab = '', ylab = 'Ilość wypadków', xaxt='n', yaxt='n')
title('Ilość wypadków w każdym dniu tygodnia')
lines(1:length(accidents_per_weekdays), kind_of_uniform_weekdays, type='l', col='#0B84A5')
lines(1:length(accidents_per_weekdays), accidents_per_weekdays, type='l', col='#CA472F')
...
plot(1:length(accidents_per_month), fully_uniform_months, type='l', col='#F6C85F', xlab = '', ylab ='Ilość wypadków', xaxt='n', yaxt='n')
title('Ilość wypadków w każdym miesiącu')
lines(1:length(accidents_per_month), kind_of_uniform_months, type='l', col='#0B84A5')
lines(1:length(accidents_per_month), accidents_per_month, type='l', col='#CA472F')
